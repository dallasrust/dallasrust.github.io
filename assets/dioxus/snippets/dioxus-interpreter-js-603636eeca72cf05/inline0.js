...
let field, ns, event_name, id, bubbles, value, ptr, len;
  ...
  for (;;) {
    ...
    while (z++ < 4) {
      switch (op & 255) {
        ...
        case 1:
          {
            stack.push(nodes[u32buf[u32bufp++]]);
          }
          break;
        case 2:
          {
            AppendChildren(u32buf[u32bufp++], u32buf[u32bufp++]);
          }
          break;
        case 3:
          {
        ...
        case 4:
          {
            root = nodes[u32buf[u32bufp++]];
            els = stack.splice(stack.length - u32buf[u32bufp++]);
            if (root.listening) {
        ...
        case 5:
          {
            nodes[u32buf[u32bufp++]].after(
              ...stack.splice(stack.length - u32buf[u32bufp++]),
            );
          }
          break;
        case 6:
          {
            nodes[u32buf[u32bufp++]].before(
              ...stack.splice(stack.length - u32buf[u32bufp++]),
            );
          }
          break;
        ...
        case 8:
          {
            stack.push(
              document.createTextNode(
                s.substring(sp, (sp += u32buf[u32bufp++])),
              ),
            );
          }
          break;
        ...
        case 11:
          ...
          listeners.create(event_name, node, bubbles);
          break;
        case 12:
          {
            node = nodes[u32buf[u32bufp++]];
            ...
            listeners.remove(node, get_evt(), u8buf[u8bufp++]);
          }
          break;
        case 13:
          {
            nodes[u32buf[u32bufp++]].textContent = s.substring(
              sp,
              (sp += u32buf[u32bufp++]),
            );
          }
        ...
        case 16:
          {
            nodes[u32buf[u32bufp++]] = LoadChild(
              u32buf[u32bufp++],
              u8buf[u8bufp++],
            );
          }
        ...
        case 17:
          ptr = u32buf[u32bufp++];
          len = u8buf[u8bufp++];
          value = s.substring(sp, (sp += u32buf[u32bufp++]));
          id = u32buf[u32bufp++];
          {
        ...
        case 18:
          {
            els = stack.splice(stack.length - u32buf[u32bufp++]);
            node = LoadChild(u32buf[u32bufp++], u8buf[u8bufp++]);
        ...
        case 19:
          {
            node =
              templates[u32buf[u32bufp++]][u32buf[u32bufp++]].cloneNode(true);
            nodes[u32buf[u32bufp++]] = node;
            stack.push(node);
          }
          break;
